// ─────────────────────────────────────────────────────────────────────────────
// HABER LİSTESİ — RSS okuma, tekilleştirme, sıralama.
//
// NEDEN AYRI DOSYA. İki tüketicisi var ve ikincisi sonradan geldi:
//   1. app/api/news/route.js       — mobil haber ekranı
//   2. app/lib/chat-share.js       — sohbette haber paylaşımı
//
// İkincisi kritik: paylaşımda İSTEMCİDEN YALNIZCA URL alınıyor, başlık ve
...
/**
 * Haber listesi — haber ekranının döndürdüğü hâlin AYNISI.
 *
 * Paylaşım çözücüsü de bunu kullanıyor; iki taraf tek kaynaktan beslenmezse
 * sohbette görünen haber, haber ekranındakinden farklı olabilirdi.
 */
export async function getNewsList(lang = 'tr') {
