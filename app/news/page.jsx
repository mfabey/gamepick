      ...
      <div style={{ maxWidth: 1180, margin: '0 auto', padding: '34px 36px 0' }}>
        ...
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: '72px 0', color: 'var(--text-3)' }}>
            ...
            <p style={{ fontSize: 17, fontWeight: 700, color: 'var(--text)', fontFamily: 'var(--font-heading)', marginBottom: 6 }}>Haberler şu an yüklenemedi</p>
            <p style={{ fontSize: 14 }}>Birazdan tekrar dene</p>
          </div>
        ) : (
          <>
            {/* ── Öne çıkan ── */}
