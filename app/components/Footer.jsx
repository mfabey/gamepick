      ...
      >
        ...
        <div>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 20, flexWrap: 'wrap', marginTop: 6 }}>
            ...
            {/* İndirme Butonları (Google Play & App Store) */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {/* Google Play */}
              <a
                href="https://play.google.com/store/apps/details?id=com.gamerisen.app"
                target="_blank"
                rel="noopener noreferrer"
                style={{
                  display: 'inline-flex',
                ...
                onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = 'var(--bg-card)'; e.currentTarget.style.borderColor = 'var(--accent-border)'; e.currentTarget.style.transform = 'translateY(-2px)'; }}
                onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = 'var(--bg-input)'; e.currentTarget.style.borderColor = 'var(--border)'; e.currentTarget.style.transform = 'translateY(0)'; }}
              >
                <svg width="18" height="18" viewBox="0 0 32 32" fill="none">
                  <path d="M26 13.5L8.5 3.5C7.2 2.7 6 3.5 6 5v22c0 1.5 1.2 2.3 2.5 1.5l17.5-10c1.3-.7 1.3-2.3 0-3z" fill="url(#gp_grad)"/>
                  <defs>
                    <linearGradient id="gp_grad" x1="6" y1="16" x2="26" y2="16" gradientUnits="userSpaceOnUse">
                      <stop offset="0" stopColor="#00F0FF"/>
                      <stop offset="0.4" stopColor="#00FF85"/>
                      <stop offset="0.7" stopColor="#FFC700"/>
                      <stop offset="1" stopColor="#FF007A"/>
                    </linearGradient>
                  </defs>
                </svg>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', lineHeight: 1.15 }}>
                  <span style={{ fontSize: 8.5, fontWeight: 600, color: 'var(--text-3)', textTransform: 'uppercase', letterSpacing: '0.06em' }}>
                    {tr ? 'ŞİMDİ İNDİRİN' : 'GET IT ON'}
                  </span>
                  <span style={{ fontSize: 13, fontWeight: 700, color: 'var(--text)', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
                    Google Play
                  </span>
                </div>
              </a>
              ...
              {/* App Store */}
              <a
                href="https://apps.apple.com/app/gamerisen/id6795211861"
                target="_blank"
                rel="noopener noreferrer"
                style={{
                  display: 'inline-flex',
              ...
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M15.97 4.17c.66-.81 1.11-1.93.99-3.06-1 .04-2.2.67-2.92 1.49-.62.71-1.16 1.85-1.01 2.96 1.1.09 2.23-.57 2.94-1.39z" fill="var(--text)" />
                </svg>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', lineHeight: 1.15 }}>
                  <span style={{ fontSize: 8.5, fontWeight: 600, color: 'var(--text-3)', textTransform: 'uppercase', letterSpacing: '0.06em' }}>
                    {tr ? 'İNDİRİN' : 'DOWNLOAD ON'}
                  </span>
                  <span style={{ fontSize: 13, fontWeight: 700, color: 'var(--text)', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
                    App Store
                  </span>
