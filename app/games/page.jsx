...
const PRICE_OPTIONS = [
  ...
  { label: '0 – 100 TL',    value: '100'  },
  { label: '0 – 300 TL',    value: '300'  },
  { label: '0 – 500 TL',    value: '500'  },
];
...
function GamesList() {
  ...
  const localizedPriceOptions = [
    ...
    { label: lang === 'tr' ? '0 – 100 TL' : '0 – $3',    value: '100'  },
    { label: lang === 'tr' ? '0 – 300 TL' : '0 – $9',    value: '300'  },
    { label: lang === 'tr' ? '0 – 500 TL' : '0 – $15',    value: '500'  },
  ];
